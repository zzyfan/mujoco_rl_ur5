...
def test_robot_arm(model_path="./models/sac/sac_robot_arm_final", 
                   normalize_path="./models/sac/vec_normalize.pkl",
                   num_episodes=10,
                   report_dir="./logs/sac/inference",
                   render=True):
    """
    测试训练好的模型
    """
...
def build_paths(root_dir):
    algo_dir = os.path.join(root_dir, "sac")
    ...
    return {
        ...
        "final_model_path": os.path.join(models_dir, "sac_robot_arm_final"),
        ...
        "interrupted_model_path": os.path.join(interrupted_dir, "sac_robot_arm_interrupted"),
...
def build_legacy_paths():
    return {
        "final_model_path": os.path.join(".", "models", "sac", "sac_robot_arm_final"),
        "final_vec_path": os.path.join(".", "models", "sac", "vec_normalize.pkl"),
        "best_model_path": os.path.join(".", "logs", "best_model", "best_model"),
        "best_vec_path": os.path.join(".", "logs", "sac", "best_model", "vec_normalize.pkl"),
        "interrupted_model_path": os.path.join(".", "models", "sac", "interrupted", "sac_robot_arm_interrupted"),
        "interrupted_vec_path": os.path.join(".", "models", "sac", "interrupted", "vec_normalize.pkl"),
    }
