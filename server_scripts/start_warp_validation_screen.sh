#!/usr/bin/env bash
# 一键在服务器上用 screen 启动 warp GPU 验证线。
...
SESSION_NAME="${SESSION_NAME:-warp_validation_queue}"
LOG_FILE="${LOG_FILE:-/root/autodl-tmp/mujoco_rl_ur5/server_logs/warp_validation_queue.log}"
